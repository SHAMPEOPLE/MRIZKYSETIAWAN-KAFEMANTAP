            ...
            <div class="col-sm-7 ps-3">
                <div class="card-body">
                    ...
                    <p class="mb-4 text-dark">
                        Anda telah selesai <span class="fw-bold">72%</span> lebih banyak penjualan hari ini. Periksa lencana baru Anda
                        profil Anda.
                    </p>
        ...
        <div class="col-lg-5 col-md-12 col-6 mb-4 shadow rounded">
            <div class="card">
                <div class="card-body">
                    ...
                    <span class="fw-semibold d-block mb-1 text-dark">Penghasilan</span>
        ...
        <div class="col-lg-5 col-md-12 col-6 mb-4 shadow rounded">
            <div class="card">
                <div class="card-body">
                    ...
                    <span class="fw-semibold d-block mb-1 text-dark">Faktur</span>
