                ...
                <div class="col-md-5">
                    <div class="card border-0">
                        <div class="card-header pb-0">
                            ...
                            <p class="card-text text-muted mt-4  space"> DETAILS PEMBAYARAN</p>
                            <hr class="my-0">
                        </div>
                        @foreach($data as $key)
                        @if($key->status == 'paid')
                        <div class="card-body">
                            ...
                            <div class="form-group mb-3">
                                <label for="name_cashier" class="small text-muted fw-semibold mb-1">NAMA PADA KASIR</label>
                            ...
                            <div class="form-group mb-3">
                                <label for="total_transaction" class="small text-muted fw-semibold mb-1">TOTAL TRANSAKSI</label>
                            ...
                            <div class="form-group mb-3">
                                <label for="total_payment" class="small text-muted fw-semibold mb-1">JUMLAH PEMBAYARAN</label>
                            ...
                            <div class="row mb-md-5 mt-4">
                                <div class="col">
                                    <a onclick="show_my_receipt1()" class="text-white btn btn-info w-100 btn-block ">Tunjukkan Tanda Terima</a>
                                </div>
                            </div>   
                        </div>
                        ...
                        <form action="/transaction/{{ $key->id }}" method="POST" class="card-body">
                            ...
                            <div class="form-group mb-3">
                                <label for="total_transaction" class="small text-muted fw-semibold mb-1">TOTAL TRANSAKASI</label>
                                <input type="text" class="form-control form-control-sm" disabled name="total_transaction" id="total_transaction" value="{{ number_format($key->total_transaction, 0, ',', '.') }}">
