...
@section('container')
    <h1 class="app-page-title mb-4">Tambahkan Menu Baru</h1>
    <div class="col-lg-8">
            ...
            <div class="mb-3">
                ...
                <div class="img-area">
                    ...
                    <div class="view-path-img" data-path="false">
                        <h3>Upload gambar</h3>
                        <p>ambil gambar yang bagus jangan yang jelek<span>2MB</span></p>
                    </div>
                </div>
            </div>
            <div class="mb-4">
                <button class="btn-submit btn btn-primary" type="submit">Tambahkan ke Menu</button>
            </div>
        </form>
    </div>
    <script>
